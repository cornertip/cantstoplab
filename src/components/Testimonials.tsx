...
const testimonials = [
  { quote: "CantStopLab ha trasformato completamente la nostra presenza su Instagram. I numeri parlano da soli.", name: "Giulia Ferri", company: "Maison Beauté", photo: reviewer1 },
  { quote: "Professionali, creativi e sempre un passo avanti. Il miglior investimento per il nostro brand.", name: "Alessandro Conti", company: "FitPro Academy", photo: reviewer2 },
  { quote: "Da zero a 50K follower in 4 mesi. Non avremmo mai pensato fosse possibile.", name: "Luca Moretti", company: "Gusto Italiano", photo: reviewer3 },
];
          ...
          <div className="flex justify-center gap-3 mt-12">
            {testimonials.map((_, i) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-500 ${i === current ? "bg-primary w-12" : "bg-border w-8 hover:bg-muted-foreground/30"}`}
              />
            ))}
          </div>
        </div>
