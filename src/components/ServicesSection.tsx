    ...
    <section id="servizi" ref={ref} className="section-fade-in py-32 bg-background relative">
      <div className="container mx-auto px-4">
        <div className="max-w-xl mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-display text-foreground leading-[1.05]">Tutto quello che serve per dominare i canali social.
            <span className="italic text-primary">dominare</span> i vertical video.
          </h2>
        </div>
